...
import { motion } from "framer-motion"; //deal with all the motion
...
const About = () => {
  return (
    <>
      ...
      <motion.p 
      // fadeIn(direction,start,delay,duration)
      ...
      max-w-3xl leading-[30px]'>
        ...
        Node.js, and Three.js. I'm a quick leaner
      ...
      <div className='mt-20 flex flex-wrap gap-10'>
        {services.map((service,index)=>(
          ...
          key={service.title}
          index={index}
          {...service} //extract all the props, and pass them 
          />
        )      
        )}
      </div>
